...
class Subjects{
    ...
    Subjects(String title, double internal, double theory, double totalMarks) 
    {
        this.title = title;
...
public class news{
    ...
    news(String name, String stream, String college, int rollNo, String semester,double Total, Subject...sub) {
        this.name = name;
        this.stream = stream;
    ...
    public String toString() {
        return "\nStudent Name = "+this.name + "\nRoll no = " + this.rollNo + "\nStream = " + this.stream + "\nSemester = " + this.semester + "\nCollege = "
                + this.college + "\nTotal Marks = "+this.totalMarks+"/300";
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        news Student1 = new news(name, stream, college, rollNo, semester, Total );
        Total=0.0;
        System.out.println("\n----------Student 2---------");
        System.out.print("Name: ");
        name = buf.readLine();
        ...
        news Student2 = new news(name, stream, college, rollNo, semester, Total );
        System.out.println("\n------------Student Information-----------");
